...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("spherical_3d", 3, "radial_at_r", (1.0,), "r"),
        ...
        pytest.param("spherical_3d", 4, "azimuthal_average", (), "phi", marks=pytest.mark.xfail(reason="known bug in azimuthal_average")),
        ...
        pytest.param("polar_3d", 2, "vertical_at_midplane", (), "z", marks=pytest.mark.xfail(reason="vertical_at_midplane slices onto a cell center, which in this instance cannot exactly match idefix, slicing at a cell edge")),
        pytest.param("polar_3d", 3, "radial_at_r", (2.0078125,), "R"),
        ...
        pytest.param("polar_3d", 4, "azimuthal_average", (), "phi", marks=pytest.mark.xfail(reason="known bug in azimuthal_average")),
